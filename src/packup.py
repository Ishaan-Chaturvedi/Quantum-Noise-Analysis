...
from simulate.result import interpret_result, measurement_fidelity, operator_fidelity,measurement_trace,operator_trace
...
circuit=bellstategenerator(measure=False)
...
print(operator_trace(noise_result,ideal_result))
