...
from simulate.result import interpret_result, measurement_fidelity, operator_fidelity,measurement_trace,operator_trace,information_gain
...
print(information_gain(noise_result,ideal_result))
